...
internal fun Logger.popcornLoggerLifecycle(message: String) {
    lifecycle(
        LOGGER_PREFIX + GREEN_COLOR + message + RESET_COLOR
    )
}

internal fun Logger.popcornLoggerInfo(message: String) {
    info(
...
internal fun Logger.popcornLoggerDebug(message: String) {
    debug(
        LOGGER_PREFIX + YELLOW_COLOR + message + RESET_COLOR
    )
}
